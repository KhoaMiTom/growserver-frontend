      ...
      <div class="grid md:grid-cols-2">
        ...
        <div class="relative hidden md:block">
          ...
          <div class="relative z-20 h-full flex flex-col items-center justify-center p-8 text-center">
            <h1 class="text-4xl font-bold text-white mb-4 animate-fade-in">Welcome Back!</h1>
          </div>
        </div>
        ...
        <div class="p-8 md:p-12">
          ...
          >
            ...
            <div class="flex flex-col space-y-4">
              ...
              <div class="flex items-center justify-center space-x-2 text-sm animate-fade-in-up" style="animation-delay: 0.4s">
